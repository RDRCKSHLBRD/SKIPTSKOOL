  ...
  cart.forEach(item => {
    ...
    <div class="cart-item-controls">
        <div class="cart-item-quantity">
            <button class="quantity-btn quantity-decrease" onclick="decreaseQuantity(${cart.indexOf(item)})">-</button>
            <span class="quantity-value">${item.quantity}</span>
            <button class="quantity-btn quantity-increase" onclick="increaseQuantity(${cart.indexOf(item)})">+</button>
        </div>
